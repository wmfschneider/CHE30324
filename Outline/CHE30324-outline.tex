...
\label{sec:org86019cc}
\subsection{Lecture 0: Introduction}
\label{sec:org813c66c}
\begin{enumerate}
...
\label{sec:orgd325b24}
\subsubsection{Classical rigid rotor}
\label{sec:orged3353c}
\begin{enumerate}
...
\label{sec:orgc0bcd08}
\subsubsection{Schr\"{o}dinger equation}
\label{sec:org3b7ea56}
\begin{enumerate}
...
\label{sec:org4e73181}
\subsubsection{Qualtitative bonding}
\label{sec:orgf068168}
\begin{enumerate}
...
\label{sec:orgf89e86b}
\subsubsection{Have to specify:}
\label{sec:orgb433047}
\begin{enumerate}
...
\label{sec:orgc8193eb}
\subsubsection{Partition function}
\label{sec:orgf29fa6e}
\begin{enumerate}
...
\label{sec:org48ae353}
\subsubsection{Ideal gas of molecules}
\label{sec:org0f2c29d}
\begin{displaymath}
...
\label{sec:org412c8dd}
\subsubsection{Many-particle molecule}
\label{sec:orgd9c1e36}
\begin{enumerate}
...
\item Ethane dehydrogenation, \ce{C2H6 -> C2H4 + H2}, 1 bar standard state
\end{enumerate}
...
\label{sec:org89b4c5d}
\subsubsection{Thermodynamic connection}
\label{sec:orgfb63282}
\begin{enumerate}
