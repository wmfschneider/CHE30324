...
\label{sec:orgd4ade67}
\subsection{Lecture 0: Introduction}
\label{sec:org05c3395}
\begin{enumerate}
...
\label{sec:org189e7aa}
\subsubsection{Classical rigid rotor}
\label{sec:org79a49a0}
\begin{enumerate}
...
\label{sec:org95e3f93}
\subsubsection{Schr\"{o}dinger equation}
\label{sec:org601cf8d}
\begin{enumerate}
...
\label{sec:org2f7eb38}
\subsubsection{Qualtitative bonding}
\label{sec:org1275a2d}
\begin{enumerate}
...
\label{sec:org4b935cc}
\subsubsection{Have to specify:}
\label{sec:org21ceefd}
\begin{enumerate}
...
\label{sec:orgeff58e7}
\subsubsection{Partition function}
\label{sec:org63fd24a}
\begin{enumerate}
...
\label{sec:org06700e2}
\subsubsection{Ideal gas of molecules}
\label{sec:orge1c9927}
\begin{displaymath}
...
\label{sec:org8ac5aab}
\subsubsection{Many-particle molecule}
\label{sec:orgffec50d}
\begin{enumerate}
...
\label{sec:org0bd43bd}
\subsubsection{Thermodynamic connection}
\label{sec:org8598735}
\begin{enumerate}
