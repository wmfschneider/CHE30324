...
\label{sec:org2255051}
\subsection{Lecture 0: Introduction}
\label{sec:org3578751}
\begin{enumerate}
...
\label{sec:org59cea4c}
\subsubsection{Classical rigid rotor}
\label{sec:orgca97fb7}
\begin{enumerate}
...
\label{sec:org6cd0f99}
\subsubsection{Schr\"{o}dinger equation}
\label{sec:org48a5fdd}
\begin{enumerate}
...
\label{sec:orge87f106}
\subsubsection{Qualtitative bonding}
\label{sec:org0ee8d0d}
\begin{enumerate}
...
\label{sec:org2197a81}
\subsubsection{Have to specify:}
\label{sec:org5d3559d}
\begin{enumerate}
...
\label{sec:org2c436c2}
\subsubsection{Partition function}
\label{sec:org7110d3b}
\begin{enumerate}
...
\label{sec:orgf2b8c4f}
\subsubsection{Ideal gas of molecules}
\label{sec:orgfd747c5}
\begin{displaymath}
...
\label{sec:orgeaf2e6d}
\subsubsection{Many-particle molecule}
\label{sec:org94f76c3}
\begin{enumerate}
...
\label{sec:org1903913}
\subsubsection{Thermodynamic connection}
\label{sec:org1be55c3}
\begin{enumerate}
