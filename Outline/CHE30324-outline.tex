...
\label{sec:org2db33c5}
\subsection{Lecture 0: Introduction}
\label{sec:org0a3b742}
\begin{enumerate}
...
\label{sec:org7dff8f4}

\begin{table}
\caption{(left) Blackbody irradiance. (right) Average energy of a Planck quantized oscillator}
\begin{tabular}{cc}
\includegraphics[scale=0.55]{./Images/BlackBody.png} &
\includegraphics[scale=0.55]{./Images/Planck.png} 
\end{tabular}
\end{table}
...
\label{sec:org5981866}
\subsubsection{Classical rigid rotor}
\label{sec:org0a54bf1}
\begin{enumerate}
...
\label{sec:orge978919}
\subsubsection{Schr\"{o}dinger equation}
\label{sec:org0fd2e65}
\begin{enumerate}
...
\label{sec:orgfee9b9f}
\subsubsection{Qualtitative bonding}
\label{sec:org4fee3e4}
\begin{enumerate}
...
\end{enumerate}
\end{enumerate}
\subsubsection{The H\"{u}ckel/\#+title:}
\label{sec:org5db6630}
ght binding model: \href{http://resolver.caltech.edu/CaltechBOOK:1961.001}{Roberts, Notes on Molecular Orbital Theory}
\begin{enumerate}
...
\label{sec:orge297d3d}
\subsubsection{Have to specify:}
\label{sec:org714838e}
\begin{enumerate}
...
\label{sec:org5bbb6e6}
\subsubsection{Partition function}
\label{sec:org662540e}
\begin{enumerate}
...
\label{sec:org98abae6}
\subsubsection{Ideal gas of molecules}
\label{sec:orgb8e49bd}
\begin{displaymath}
...
\label{sec:org0161463}
\subsubsection{Many-particle molecule}
\label{sec:org4f05a00}
\begin{enumerate}
...
K_{eq}(T) & = &\frac{q_B^\circ(T)}{q_A^\circ(T)} e^{-\Delta U(0)/kT} = e^{-\Delta G^\circ(T)/kT} 
 \end{eqnarray*}
\item ICE/equilibrium calculation for \ce{H2C=CH(OH) -> CH3CH(O)}
...
\item ICE/equilibrium calculation for ethane dehydrogenation, \ce{C2H6 -> C2H4 + H2}, 1 bar standard state
\end{enumerate}
...
\label{sec:org2dc93b6}
\begin{enumerate}
\item Example: \ce{H2C=CH(OH) -> CH3CH(O)}, endothermic
\item Response to temperature: Boltzmann distribution favors higher energy things as \(T\) increases
\item Example: ethane dehydrogenation, \ce{C2H6 -> C2H4 + H2}, positive entropy
...
\label{sec:org7261f8e}
\subsubsection{Thermodynamic connection}
\label{sec:orgaab3373}
\begin{enumerate}
...
\label{sec:orge84b549}
\begin{enumerate}
\item molecule-surface collisions
\item surface reactions
\item Ammonia oxidation, \ce{NH3 + O2 -> NO + N2 + N2O}, \href{http://pubs.acs.org/doi/10.1021/acscatal.8b04251}{doi:10.1021/acscatal.8b04251}
\end{enumerate}
