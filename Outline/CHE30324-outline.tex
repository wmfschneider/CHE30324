...
\label{sec:orgd44973f}
\subsection{Lecture 0: Introduction}
\label{sec:orgeaccfe7}
\begin{enumerate}
...
\begin{enumerate}
\item ``hybridize'' Li 2s and Li 2p to get \emph{three} H 1s + Li sp\(^2\) bonds, yields trigonal \ce{BH3}
\end{enumerate}
\item CH: same ideas lead to tetrahedral \ce{CH4}, gas
...
\label{sec:org818dea0}
\subsubsection{Ideal gas of molecules}
\label{sec:orga0de215}
\begin{displaymath}
...
\label{sec:orgd48f67e}
\subsubsection{Many-particle molecule}
\label{sec:orgb7bb0a3}
\begin{enumerate}
