...
\label{sec:org91788d4}
\subsection{Lecture 0: Introduction}
\label{sec:org433ec1e}
\begin{enumerate}
...
\label{sec:orgba03495}
\subsubsection{Properties of waves}
\label{sec:org12435f3}
\begin{enumerate}
...
\label{sec:orgfdcf7d4}
\subsubsection{Classical rigid rotor}
\label{sec:orgac7b499}
\begin{enumerate}
...
\label{sec:orgac4b58b}
\subsubsection{Schr\"{o}dinger equation}
\label{sec:orgbe03885}
\begin{enumerate}
...
\label{sec:org8f826f2}
\subsubsection{Qualtitative bonding}
\label{sec:org67d4a65}
\begin{enumerate}
...
\label{sec:orgda9cd43}
\subsubsection{Have to specify:}
\label{sec:org4c0cd9e}
\begin{enumerate}
...
\label{sec:orgc9bb79e}
\subsubsection{Partition function}
\label{sec:org6c3ce79}
\begin{enumerate}
...
\label{sec:orgf09d83e}
\subsubsection{Ideal gas of molecules}
\label{sec:org05416fc}
\begin{displaymath}
...
\label{sec:orgd285b67}
\subsubsection{Many-particle molecule}
\label{sec:org02ff9fa}
\begin{enumerate}
...
\label{sec:org2dc3530}
\subsubsection{Thermodynamic connection}
\label{sec:orgba105fc}
\begin{enumerate}
