...
2. Compute total energy vs distance
...
# harmonic frequency
k = 2*coef[2]            # eV/Ang^2
muH2 = massH/np.sqrt(2.) # eV / c^2
nu = (1/(2*np.pi))*np.sqrt(k/muH2)  # c/Ang
nu = nu * c / 1e-10   # /s
nutilde = nu/c /100  # /cm

EHB3LYP = -0.4969*HeV
Edissoc = 2*EHB3LYP-emin
...
print('              -----                  ')
print('E Dissoc (eV):{0:5.2f}                '.format(Edissoc))
print()
print('nutilde {}'.format(nutilde))
...
#+RESULTS:
#+begin_example
[-20.04869711 -31.48303415  21.07102453]
------------------------------
              B3LYP       EXPT  
------------------------------
H-H (Ang) :   0.747       0.742
